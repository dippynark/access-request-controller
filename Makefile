CONTROLLER_IMG ?= dippynark/access-request-controller:latest
WEBHOOK_IMG ?= dippynark/access-request-webhook:latest
...
deploy: manifests
	...
	cd config/webhook \
		&& kustomize edit set image webhook=${WEBHOOK_IMG}
